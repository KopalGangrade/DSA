...
# For Example: The below list of characters is sorted in increasing order of their ASCII values. That is, 
# the character with a lesser ASCII value will be placed first than the character with a higher ASCII value.